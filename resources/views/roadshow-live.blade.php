<x-layouts.screen title="Roadshow Live" js-entry="resources/js/spin/live-view.js">
    ...
    <div class="flex h-screen w-screen flex-col items-center bg-white px-3 py-4">
        ...
        <div class="relative mt-5 aspect-square w-[min(88vw,720px)] shrink-0">
            ...
            <div class="pointer-events-none absolute left-1/2 top-1/2 z-10 grid h-16 w-16 -translate-x-1/2 -translate-y-1/2 place-items-center rounded-full border-[3px] border-slate-900 bg-white pixel-shadow-lg">
